 ...
 */
function freakcroak_customize( $wp_customize ) {
	...
	$wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'header_logo', array(
		'label'       => __( 'Upload Header Logo', 'freakcroak' ),
		'description' => __( 'Height: &gt;80px', 'freakcroak' ),
	...
	$wp_customize->add_control( 'navbar_scheme', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar Scheme', 'freakcroak' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
						'navbar-light bg-light'  => __( 'Default', 'freakcroak' ),
						'navbar-dark bg-dark'    => __( 'Dark', 'freakcroak' ),
						'navbar-dark bg-primary' => __( 'Primary', 'freakcroak' ),
					),
	...
	$wp_customize->add_control( 'navbar_position', array(
		'type'     => 'radio',
		'label'    => __( 'Navbar', 'freakcroak' ),
		'section'  => 'theme_header_section',
		'choices'  => array(
						'static'       => __( 'Static', 'freakcroak' ),
						'fixed_top'    => __( 'Fixed to top', 'freakcroak' ),
						'fixed_bottom' => __( 'Fixed to bottom', 'freakcroak' ),
					),
	...
	$wp_customize->add_control( 'search_enabled', array(
		'type'     => 'checkbox',
		'label'    => __( 'Show Searchfield?', 'freakcroak' ),
		'section'  => 'theme_header_section',
		'settings' => 'search_enabled',
		'priority' => 3,
	) );
}
add_action( 'customize_register', 'freakcroak_customize' );


/**
 * Bind JS handlers to make Theme Customizer preview reload changes asynchronously.
 */
function freakcroak_customize_preview_js() {
	wp_enqueue_script( 'customizer', get_template_directory_uri() . '/inc/customizer.js', array( 'jquery' ), null, true );
}
add_action( 'customize_preview_init', 'freakcroak_customize_preview_js' );
